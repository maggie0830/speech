...
#    def recognize_sphinx(self, audio_data, language = "en-US", show_all = False):
    def recognize_sphinx(self, audio_data, language = "de-DE", show_all = False):
        """
    ...
    def recognize_google(self, audio_data, key = None, language = "de-DE", show_all = False):
        ...
        The recognition language is determined by ``language``, an RFC5646 language tag like ``"en-US"`` (US English) or ``"de-DE"`` (International French), defaulting to US English. A list of supported language values can be found in this `StackOverflow answer <http://stackoverflow.com/a/14302134>`__.
    ...
    def recognize_bing(self, audio_data, key, language = "de-DE", show_all = False):
        """
        ...
        The recognition language is determined by ``language``, an RFC5646 language tag like ``"en-US"`` (US English) or ``"de-DE"`` (International French), defaulting to US English. A list of supported language values can be found in the `API documentation <https://www.microsoft.com/cognitive-services/en-us/speech-api/documentation/api-reference-rest/BingVoiceRecognition#user-content-4-supported-locales>`__.
    ...
    def recognize_ibm(self, audio_data, username, password, language = "de-DE", show_all = False):
        """
...
def recognize_att(self, audio_data, app_key, app_secret, language = "de-DE", show_all = False):
